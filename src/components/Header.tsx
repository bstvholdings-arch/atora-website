  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-gray-200">
      ...
      <div className="border-b border-gray-100 bg-brand-50/40">
        <div className="container-fluid flex items-center justify-between py-2 text-xs text-brand-700">
          <div className="hidden sm:block truncate">
            <span className="font-semibold text-brand-800">{t(lang, 'footer.serviceArea')}</span>
            <span className="mx-2 text-gray-300">·</span>
            <span>{t(lang, 'common.tagline')}</span>
          </div>
          <div className="flex items-center gap-2 ml-auto">
            <span className="hidden sm:inline text-gray-500">{t(lang, 'common.language')}:</span>
      ...
      <div className="container-fluid flex items-center justify-between py-3">
        ...
        <Link href={`/${lang}`} className="group flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-md bg-brand-600 text-white font-bold text-xl shadow-sm group-hover:bg-brand-700 transition">
            A
          </div>
          <div className="leading-tight">
            <div className="font-bold text-brand-800 text-base sm:text-lg">ATORA</div>
            <div className="text-[11px] sm:text-xs text-gray-500">东京冷气电器有限公司</div>
          </div>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Link href={`/${lang}/contact`} className="btn-primary hidden lg:inline-flex">
        ...
        <button
          ...
          className="lg:hidden ml-2 p-2 rounded-md text-brand-700 hover:bg-brand-50"
        ...
        <div className="lg:hidden border-t border-gray-200 bg-white">
          <div className="container-fluid py-3 space-y-1">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <Link href={`/${lang}/contact`} className="btn-primary flex-1">
                {t(lang, 'common.getQuote')}
              </Link>
            </div>
          </div>
